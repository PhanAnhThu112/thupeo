                                ...
                                <div class="single-item">
                                    ...
                                    <div class="single-item-body">
                                        ...
                                        <p class="single-item-price">
                                            <span class="flass-del">{{$new ->unit_price}} đồng</span>
                                            <span class="flass-sale">{{$new -> promotion_price}} đồng </span>
                                    ...
                                    <div class="single-item-caption">
                                        ...
                                        <a class="beta-btn primary" href="chitiet_sanpham/{{$new->id}}">Details <i
                    ...
                    <div class="beta-products-list">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="single-item">
                                    <div class="single-item-header">
                                        <a href="chitiet_sanpham/{{$spkm->id}}"><img src="source/image/product/{{$spkm->image}}"
                                                alt=""></a>
                                    </div>
                                    <div class="single-item-body">
                                    ...
                                    <div class="single-item-caption">
                                        <a class="add-to-cart pull-left" href="shopping_cart.html"><i
                                                class="fa fa-shopping-cart"></i></a>
                                                <a class="beta-btn primary" href="chitiet_sanpham/{{$spkm->id}}">Details <i
                                                class="fa fa-chevron-right"></i></a>
                                        <div class="clearfix"></div>
                                    </div>
                                </div>
